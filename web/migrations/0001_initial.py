    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idc', models.ForeignKey(to='web.DIC')),
            ],
            options={
                'verbose_name': '\u4e3b\u673a',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bind_hosts', models.ManyToManyField(to='web.BindHosts', verbose_name='\u6388\u6743\u4e3b\u673a')),
            ...
            options={
                'verbose_name': 'SkynetEye\u8d26\u6237',
                'verbose_name_plural': 'SkynetEye\u8d26\u6237',
            },
        ),
        migrations.AddField(
            model_name='token',
